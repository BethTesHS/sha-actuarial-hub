export const module4Data = {
  ...
  learningOutcomes: {
    ...
    points: [
      ...
      "Communicate reserving results, assumptions, and limitations effectively to non-technical stakeholders, including management and regulators.",
  ...
  courseContent: {
    ...
    resources: [
      {
        title: "KAFS - Guidelines on Valuation for General Insurance Business_2025.pdf",
  ...
  additionalResources: [
    {
      title: "Circular No. COFN_IRA_00_001_03 - Implementation of IFRS-17 Standard",
      type: "PDF",
      url: "/Training Modules/Module 4_General Insurance Valuation/Additional Resources/Circular No. COFN_IRA_00_001_03 - Implementation of IFRS-17 Standard.pdf",
      filename: "Circular No. COFN_IRA_00_001_03 - Implementation of IFRS-17 Standard.pdf",
    },
    {
      title: "IFRS-17 Insurance Contracts",
      type: "PDF",
      url: "/Training Modules/Module 4_General Insurance Valuation/Additional Resources/ifrs-17-insurance-contracts.pdf",
      filename: "ifrs-17-insurance-contracts.pdf",
    },
    {
      title: "The Insurancce (Valuation of Technical Provisions) - Guidelines 2017",
      type: "PDF",
      url: "/Training Modules/Module 4_General Insurance Valuation/Additional Resources/The Insurancce (Valuation of Technical Provisions for General Insurance Business) Guidelines 2017.pdf",
      filename: "The Insurancce (Valuation of Technical Provisions for General Insurance Business) Guidelines 2017.pdf",
    },
  ],
